...
public class StudentRecordBean {
    ...
    public void StudentImgUpload(ValueChangeEvent valueChangeEvent) {
        try
        {
          UploadedFile file = (UploadedFile) valueChangeEvent.getNewValue();
          BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
          DCIteratorBinding iter = (DCIteratorBinding) bindings.get("StudentsView1Iterator");
    ...
    public String SaveDetails() {
        ...
        op.execute();
        FacesContext context = FacesContext.getCurrentInstance();
        context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Student Data Saved Sucessfully..", null));
        return null;
    }
}
